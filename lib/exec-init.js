...
buildGlobals(window, windowGlobal, windowGlobalOverrides, windowGlobalExtras)
...
buildGlobals(document, documentGlobal, documentGlobalOverrides)
...
function buildGlobals(source, target, overrides, extras) {
