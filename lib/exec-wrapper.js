...
;(function(){
  ...
  // add implicit globals onto window

  var IMPLICIT_GLOBALS = "INSERT IMPLICIT GLOBALS HERE"

  var implicitCtx = IMPLICIT_GLOBALS
    .map(function(key){ return 'if (typeof '+key+' !== "undefined") window["'+key+'"] = '+key+';' })
    .join('\n')
